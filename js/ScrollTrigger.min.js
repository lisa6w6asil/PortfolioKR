...
!function(e, t) {
    ...
    function F(r, n) {
        function Qc(e) {
            if (e || 0 === e) {
                ...
                (n || k.cache !== Qc.cacheID || i("ref")) && (Qc.cacheID = k.cache, Qc.v = r());
    ...
    var C = (Observer.prototype.init = function init(e) {
        ...
        function Qe() {
            ...
            r && (m && 0 < se.deltaX && m(se), y && se.deltaX < 0 && y(se), _ && _(se), k && se.deltaX < 0 != le < 0 && k(se), le = se.deltaX, be[0] = be[1] = be[2] = 0),
            n && (w && 0 < se.deltaY && w(se), x && se.deltaY < 0 && x(se), S && S(se), C && se.deltaY < 0 != ce < 0 && C(se), ce = se.deltaY, me[0] = me[1] = me[2] = 0),
        ...
        function Te(e) {
            if (!Oe(e, 1)) {
                ...
                se.x = t,
                se.y = r,
                (i || Math.abs(se.startX - t) >= a || Math.abs(se.startY - r) >= a) && (h && (re = !0), i || (se.isDragging = !0), Se(n, o), i || p && p(se))
            }
        }
        function Ve(t) {
            if (!Oe(t, 1)) {
    ...
    function Ib(e) {
        for (var t = 0; t < W.length; t += 5)
            (!e || W[t + 4] && W[t + 4].query === e) && (W[t].style.cssText = W[t + 1], W[t].getBBox && W[t].setAttribute("transform", W[t + 2] || ""), W[t + 3].uncache = 1)
    }
    function Jb(e, t) {
        var r;
        ...
        re = (ScrollTrigger.prototype.init = function init(S, T) {
            if (this.progress = this.start = 0, this.vars && this.kill(!0, !0), vt) {
                    ...
                    if (!ot && _e.enabled || t)
                        if (oe && e && ht)
                            ...
                            for (var r, n, o, i, a, s, l, c, u, f, d = Te(), p = ke(), g = fe ? fe.duration() : Ha(ve, ge), h = 0, v = 0, b = S.end, m = S.endTrigger || ne, y = S.start || (0 !== S.start && ne ? oe ? "0 0" : "0 100%" : 0), x = _e.pinnedContainer = S.pinnedContainer && I(S.pinnedContainer), w = ne && Math.max(0, Pt.indexOf(_e)) || 0, _ = w; _--;)
                                ...
                                s !== Pt[_] && (w--, _--);
                            for (Ka(y) && (y = y(_e)), M = _b(y, ne, d, ge, Me(), C, D, _e, p, we, me, g, fe) || (oe ? -.001 : 0), Ka(b) && (b = b(_e)), Ja(b) && !b.indexOf("+=") && (~b.indexOf(" ") ? b = (Ja(y) ? y.split(" ")[0] : "") + b : (h = tb(b.substr(2), d), b = Ja(y) ? y : M + h, m = ne)), O = Math.max(M, _b(b || (m ? "100% 0" : g), m, d, ge, Me() + h, P, B, _e, p, we, me, g, fe)) || -.001, z = O - M || (M -= .01) && .001, h = 0, _ = w; _--;)
                                (l = (s = Pt[_]).pin) && s.start - s._pinPush < M && !fe && 0 < s.end && (r = s.end - s.start, l !== ne && l !== x || La(y) || (h += r * (1 - s.progress)), l === oe && (v += r));
                            if (M += h, O += h, _e._pinPush = v, C && h && ((r = {})[ge.a] = "+=" + h, x && (r[ge.p] = "-=" + Me()), qe.set([C, P], r)), oe)
                                ...
                                n = Mt(oe, !0),
                                c = me && J(ve, i ? He : Je)(),
                                ie && ((H = [ie + ge.os2, z + v + Et]).t = F, (_ = ie === Tt ? hb(oe, ge) + z + v : 0) && H.push(ge.d, _ + Et), Bt(H), me && Me(Q)),
                                me && ((a = {
                                ...
                                T ? (u = T._initted, lt(1), T.render(T.duration(), !0, !0), N = X(ge.a) - K + z + v, z !== N && me && Y.splice(Y.length - 2, 2), T.render(0, !0, !0), u || T.invalidate(!0), T.parent || T.totalTime(T.totalTime()), lt(0)) : N = z;
                            else if (ne && Me() && !fe)
                            ...
                            j === _e.progress && !fe || (T && !he && T.totalProgress(j, !0), _e.progress = (A - M) / z === j ? 0 : j),
                ...
                _e.update = function(e, t, r) {
                    if (!fe || r || e) {
                        ...
                        if (t && (E = A, A = fe ? Me() : u, ce && (V = _, _ = T && !he ? T.totalProgress() : d)), se && !d && oe && !ot && !pt && ht && M < u + (u - E) / (gt() - nt) * se && (d = 1e-4), d !== p && _e.enabled) {
                            ...
                            !Z || he || e || Z(_e),
                            a && !ot ? (he && (c && ("complete" === i ? T.pause().totalProgress(1) : "reset" === i ? T.restart(!0).pause() : "restart" === i ? T.restart(!0) : T[i]()), Z && Z(_e)), !s && ut || (ee && s && Oa(_e, ee), ye[o] && Oa(_e, ye[o]), le && (1 === d ? _e.kill(!1, 1) : ye[o] = 0), s || ye[o = 1 === d ? 1 : 3] && Oa(_e, ye[o])), de && !n && Math.abs(_e.getVelocity()) > (La(de) ? de : 2500) && (Na(_e.callbackAnimation), W ? W.progress(1) : Na(T, "reverse" === i ? 1 : !d, 1))) : he && Z && !ot && Z(_e)
                        }
                        if (w) {
                ...
                _e.kill = function(e, t) {
                    ...
                    dt === _e && (dt = 0),
                    oe && (n && (n.uncache = 1), r = 0, Pt.forEach(function(e) {
                        return e.pin === oe && r++
                    }), r || (n.spacer = 0)),
        ...
        return h && qe.set(h, {
            ...
            if (v.offset && rp(), t) {
                ...
                var r,
                    n,
                    o = w();
                f && (n = (r = b()) + .05 * o * -e.velocityX / .227, o *= ec(b, r, n, Ha(d, He)), a.vars.scrollX = S(n)),
